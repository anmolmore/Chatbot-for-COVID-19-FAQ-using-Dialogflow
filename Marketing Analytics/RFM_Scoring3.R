...
prob.model = glm(formula = active_2015 ~ recency + first_purchase + frequency + avg_amount + max_amount,  family=binomial, data = in_sample )
summary(prob.model)
...
customers_2015$prob_predicted    = predict(object = prob.model, newdata = customers_2015, type="response")
...
hist(customers_2015$score_predicted, breaks=1000,xlim=c(0,100))
